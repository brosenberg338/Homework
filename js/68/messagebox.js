...
window.pcs.messageBox = (function () {
  ...
  function showMessageBox(msg, modal, buttons) {
    ...
    buttonsDiv1.style.position = 'absolute';
    buttonsDiv1.style.bottom = '8px';
    buttonsDiv1.style.left = 0;
    buttonsDiv1.style.textAlign = 'center';
    buttonsDiv1.style.width = '50%';

    buttonsDiv2.style.position = 'absolute';
    buttonsDiv2.style.bottom = '8px';
    buttonsDiv2.style.left = 20;
    buttonsDiv2.style.textAlign = 'center';
    buttonsDiv2.style.width = '100%';

    buttonsDiv2.style.position = 'absolute';
    buttonsDiv2.style.bottom = '8px';
    buttonsDiv2.style.left = 20;
    buttonsDiv2.style.textAlign = 'center';
    buttonsDiv2.style.width = '75%';
